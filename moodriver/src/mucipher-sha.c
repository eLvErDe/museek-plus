...
static void shaInit(SHA_CTX *ctx) {
  int i;
...
static void shaUpdate(SHA_CTX *ctx, unsigned char *dataIn, int len) {
  int i;
...
static void shaFinal(SHA_CTX *ctx, unsigned char hashout[20]) {
