...
MAP_MESSAGE(5, SAddUser, userExistsReceivedEvent)
...
MAP_MESSAGE(36, SGetUserStats, userStatsReceivedEvent)
...
MAP_MESSAGE(83, SMsg83, message83ReceivedEvent)
MAP_MESSAGE(84, SMsg84, message84ReceivedEvent)
